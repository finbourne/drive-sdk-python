...
from lusid_drive.api_client import ApiClient as AsyncApiClient
...
import lusid_drive.extensions.retry as retry
from lusid_drive.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_drive.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for lusid_drive if needed
